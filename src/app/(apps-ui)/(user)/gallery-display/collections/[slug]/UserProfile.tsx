...
import PublishGallery from "../../publish/publish-components/PublishGallery";
                ...
                <div className="absolute w-full h-full flex z-10 bg-gradient-to-r from-palette-5 from-0% via-palette-5 md:via-15% via-25% to-transparent md:to-60% to-70%">
                    <div className="w-full h-fit pt-[20dvh] max-w-[80%] mx-auto relative flex flex-col gap-12 justify-center items-start">
                        ...
                        <div className="flex flex-col h-full left-0 ">
                            <img key={initialUserDetail.profile_pic} src={initialUserDetail.profile_pic || "images/creative-profile/image.png"} className="w-full h-full rounded-xl md:max-w-[22rem] md:min-w-[22rem] md:max-h-[32rem] min-h-[32rem] object-cover" alt="" />
                ...
                <div key={item.generatedId} className="md:h-dvh h-fit w-full bg-palette-3">
                    <div className="w-full h-full flex md:flex-row flex-col">
                        ...
                        <div className="w-full h-full min-h-[50dvh] relative">
                            <img src={item.path || "/images/creative-profile/cover.png"} className="w-full h-full object-cover absolute" alt="" />
                            <div className="w-full h-full absolute top-0 left-0 z-10 backdrop-blur-lg md:block hidden"></div>
