...
export const CreativeHeroPage = () => {
    return (
        <div className="w-full h-fit text-primary-2">
            <div className="w-full lg:max-w-[70%] md:max-w-[80%] max-w-[90%] mx-auto border border-black">
                <div className="w-full flex md:flex-col flex-col-reverse gap-12">
                    <div className="w-full flex md:flex-row flex-col gap-4 md:justify-between justify-center items-center ">
                        <h1 className="md:w-full w-fit text-5xl font-semibold border border-black uppercase">Discover</h1>
                        <div className="w-full flex md:justify-end md:items-end justify-center items-center border border-black">
                            <SearchInput />
                        </div>
                    </div>
...
const TitleDetails = () => {
    return (
        <div className="flex flex-col gap-8 md:justify-start md:items-start items-center justify-center">
            <h1 className="md:w-full w-fit max-w-sm md:text-6xl text-5xl font-extrabold border border-black uppercase leading-tight md:text-left text-center">creative directory</h1>
            <p className="font-light text-lg md:w-full w-fit max-w-lg border border-black md:text-left text-center">
...
const SearchInput = () => {
    return (
        <div className="w-full lg:max-w-xl max-w-sm h-fit relative text-primary-2 border border-black rounded-full">
            <input
