  ...
  return (
    <div className={`w-full md:h-[35dvh] h-fit ${bgColor} ${textColor}`}>
      <div className="w-full h-full flex md:flex-row md:py-0 py-12 flex-col md:justify-between justify-center  items-center md:max-w-[70%] max-w-[90%] mx-auto md:gap-0 gap-12">
        <div className="md:w-fit md:h-full h-fit flex flex-col gap-4 text-lg justify-center items-center uppercase font-semibold">
        ...
        <div className="md:w-fit md:h-full h-fit flex justify-end items-center font-semibold">
