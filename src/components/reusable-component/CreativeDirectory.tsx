  ...
  return (
    <div className={`w-full lg:h-[70dvh] h-fit  p-6 bg-shade-1 ${roundedEdges}`}>
      <div className={`w-full h-full flex lg:flex-row flex-col ${borderColor} `}>
        <div className={`w-full h-full flex flex-col p-6  md:justify-center justify-evenly md:items-start items-center lg:pl-16 px-2
        ${textGap}`}>
          ...
          <img className="w-full lg:h-full block md:hidden" src={"images/landing-page/laptop.png"} alt="" />
